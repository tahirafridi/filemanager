...
<div class="content-wrapper">
                                ...
                                <!-- __BLOCK__ --><?php if($rows->count()): ?>
                                    <!-- __BLOCK__ --><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($row->roles[0]->name ?? ''); ?></td>
                                            <td class="text-center"><span class="badge <?php echo e($row->status === 'Active' ? 'badge-success' : 'badge-danger'); ?>"><?php echo e($row->status); ?></span></td>
    ...
    <?php echo $__env->make('livewire.admin.pages.users.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<?php /**PATH /Users/tahirkhanafridi/Sites/filemanager/resources/views/livewire/admin/pages/users/index.blade.php ENDPATH**/ ?>